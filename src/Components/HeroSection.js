...
function HeroSection({ lightBg, topLine, lightText, lightTextDesc, headLine, description, buttonLabel, img, alt, imgStart }) {
    return (
        <>
            <div className={lightBg ? 'hemo__hero-section' : 'home__hero-section darkBg'}>
                    ...
                    <div className='row home__hero-row' style={{ display: 'flex', flexDirection: imgStart === 'start' ? 'row-reverse' : 'row' }}>
                        <div className='col'>
                            <div className='home__hero-text-wrapper'>
                                ...
                                <p className={lightTextDesc ? 'home__hero-subtitle' : 'home__hero-subtitle dark'}>{lightTextDesc}</p>
                                <Link to='/sign-up'>
